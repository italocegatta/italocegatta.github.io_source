...
knitr::opts_chunk$set(
  ...
  fig.width = 8, fig.height = 4, dpi = 400
)
```
...
A primeira abordagem que quero mostrar é a evolução do valor FMA ao longo do ano. Considerando o dia do ano ou dia juliano, podemos ver a evolução do valor FMA devido a ausência de chuvas fortes. O máximo dessa "corrida" de risco vai até próximo do dia 290, que corresponde ao meio de outubro.
